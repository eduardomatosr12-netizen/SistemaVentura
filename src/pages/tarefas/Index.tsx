...
const DEFAULT_BOARD: BoardType = {
  ...
  columns: [
    ...
    { id: 'col-8', title: 'ALUGUEL UNIT.', type: 'number', width: 140 },
    { id: 'col-9', title: 'VALOR CUSTO UNIT.', type: 'number', width: 140 },
  ],
  rows: [
    { id: generateUUID(), values: { 'col-1': 'Painel de Led P3.9 LPS Curvo (50x100)', 'col-2': 'Painel de LED', 'col-3': 9, 'col-4': 18, 'col-5': 'LPG', 'col-6': '', 'col-7': 75, 'col-8': 0, 'col-9': 0 }, lastModifiedBy: 'Administrador' },
    { id: generateUUID(), values: { 'col-1': 'Par Led 60 Led 3w Rgb Triled', 'col-2': 'Iluminação', 'col-3': 49, 'col-4': 50, 'col-5': 'Mercado Livre', 'col-6': '', 'col-7': 25, 'col-8': 0, 'col-9': 0 }, lastModifiedBy: 'Administrador' },
    { id: generateUUID(), values: { 'col-1': 'Varal de Lampada Comum (66 Lâmpadas)', 'col-2': 'Iluminação', 'col-3': 3, 'col-4': 1, 'col-5': 'Mercado Livre', 'col-6': '', 'col-7': 200, 'col-8': 0, 'col-9': 0 }, lastModifiedBy: 'Administrador' },
    { id: generateUUID(), values: { 'col-1': 'Varal de Lampada Japonesa (66 Lâmpadas)', 'col-2': 'Iluminação', 'col-3': 3, 'col-4': 1, 'col-5': 'Mercado Livre', 'col-6': '', 'col-7': 300, 'col-8': 0, 'col-9': 0 }, lastModifiedBy: 'Administrador' },
    { id: generateUUID(), values: { 'col-1': 'Som - Medio', 'col-2': 'Som', 'col-3': 2, 'col-4': 2, 'col-5': 'Power System', 'col-6': '', 'col-7': 175, 'col-8': 0, 'col-9': 0 }, lastModifiedBy: 'Administrador' },
    { id: generateUUID(), values: { 'col-1': 'Som - Grave', 'col-2': 'Som', 'col-3': 1, 'col-4': 2, 'col-5': 'Power System', 'col-6': '', 'col-7': 175, 'col-8': 0, 'col-9': 0 }, lastModifiedBy: 'Administrador' },
    { id: generateUUID(), values: { 'col-1': 'Som Completo (Banda)', 'col-2': 'Som', 'col-3': 1, 'col-4': 1, 'col-5': 'Power System', 'col-6': '', 'col-7': 750, 'col-8': 0, 'col-9': 0 }, lastModifiedBy: 'Administrador' },
    { id: generateUUID(), values: { 'col-1': 'Som Completo (DJ/Evento)', 'col-2': 'Som', 'col-3': 1, 'col-4': 1, 'col-5': 'Power System', 'col-6': '', 'col-7': 400, 'col-8': 0, 'col-9': 0 }, lastModifiedBy: 'Administrador' },
    { id: generateUUID(), values: { 'col-1': 'Piso Palco Praticáveis (100x200x)', 'col-2': 'Estrutura', 'col-3': 9, 'col-4': 9, 'col-5': 'Pernambuco Estruturas', 'col-6': '', 'col-7': 80, 'col-8': 0, 'col-9': 0 }, lastModifiedBy: 'Administrador' },
    { id: generateUUID(), values: { 'col-1': 'Cabine Fotografica Infinite', 'col-2': 'Outros', 'col-3': 1, 'col-4': 1, 'col-5': 'Maxi Grua', 'col-6': '', 'col-7': 500, 'col-8': 0, 'col-9': 0 }, lastModifiedBy: 'Administrador' },
    { id: generateUUID(), values: { 'col-1': 'Seta de Led', 'col-2': 'Iluminação', 'col-3': 5, 'col-4': 1, 'col-5': 'Maxi Grua', 'col-6': '', 'col-7': 200, 'col-8': 0, 'col-9': 0 }, lastModifiedBy: 'Administrador' },
    { id: generateUUID(), values: { 'col-1': 'Totem de Led P3.9 (100x200)', 'col-2': 'Painel de LED', 'col-3': 40, 'col-4': 4, 'col-5': 'LPG', 'col-6': '', 'col-7': 300, 'col-8': 0, 'col-9': 0 }, lastModifiedBy: 'Administrador' },
    { id: generateUUID(), values: { 'col-1': 'Piso Paris Galáxia', 'col-2': 'Estrutura', 'col-3': 1, 'col-4': 16, 'col-5': 'Milleto', 'col-6': '', 'col-7': 50, 'col-8': 0, 'col-9': 0 }, lastModifiedBy: 'Administrador' },
    { id: generateUUID(), values: { 'col-1': 'Moving Beem 14R LPG', 'col-2': 'Iluminação', 'col-3': 0, 'col-4': 4, 'col-5': 'LPG', 'col-6': '', 'col-7': 150, 'col-8': 0, 'col-9': 0 }, lastModifiedBy: 'Administrador' },
    { id: generateUUID(), values: { 'col-1': 'Refletor Holofote Super Led 50w - BR', 'col-2': 'Iluminação', 'col-3': 0, 'col-4': 0, 'col-5': 'Ipojuca - Caruaru', 'col-6': '', 'col-7': 25, 'col-8': 0, 'col-9': 0 }, lastModifiedBy: 'Administrador' },
    { id: generateUUID(), values: { 'col-1': 'Refletor Par 38', 'col-2': 'Iluminação', 'col-3': 0, 'col-4': 20, 'col-5': 'Mercado Livre', 'col-6': '', 'col-7': 25, 'col-8': 0, 'col-9': 0 }, lastModifiedBy: 'Administrador' },
    { id: generateUUID(), values: { 'col-1': 'Refletor Holofote Led 30W - PT', 'col-2': 'Iluminação', 'col-3': 0, 'col-4': 24, 'col-5': 'Mercado Livre', 'col-6': '', 'col-7': 25, 'col-8': 0, 'col-9': 0 }, lastModifiedBy: 'Administrador' },
    { id: generateUUID(), values: { 'col-1': 'Refletor Holofote Led 30W - BR', 'col-2': 'Iluminação', 'col-3': 0, 'col-4': 12, 'col-5': 'Mercado Livre', 'col-6': '', 'col-7': 25, 'col-8': 0, 'col-9': 0 }, lastModifiedBy: 'Administrador' },
    { id: generateUUID(), values: { 'col-1': 'Refletor Holofote Led 200w - PT', 'col-2': 'Iluminação', 'col-3': 0, 'col-4': 30, 'col-5': 'Mercado Livre', 'col-6': '', 'col-7': 25, 'col-8': 0, 'col-9': 0 }, lastModifiedBy: 'Administrador' },
    { id: generateUUID(), values: { 'col-1': 'Gride Alumínio P25 (Mt)', 'col-2': 'Estrutura', 'col-3': 0, 'col-4': 40, 'col-5': 'One Light', 'col-6': '', 'col-7': 30, 'col-8': 0, 'col-9': 0 }, lastModifiedBy: 'Administrador' },
    { id: generateUUID(), values: { 'col-1': 'Show DJ', 'col-2': 'Som', 'col-3': 0, 'col-4': 1, 'col-5': 'Ventura', 'col-6': '', 'col-7': 800, 'col-8': 0, 'col-9': 0 }, lastModifiedBy: 'Administrador' },
    { id: generateUUID(), values: { 'col-1': 'Jatos CO2', 'col-2': 'Efeitos', 'col-3': 0, 'col-4': 4, 'col-5': 'Pirulito Recife', 'col-6': '', 'col-7': 400, 'col-8': 0, 'col-9': 0 }, lastModifiedBy: 'Administrador' },
    { id: generateUUID(), values: { 'col-1': 'Efeitos Pirotécnicos', 'col-2': 'Efeitos', 'col-3': 0, 'col-4': 10, 'col-5': 'Casa do Fogueteiro - Caruaru', 'col-6': '', 'col-7': 0, 'col-8': 0, 'col-9': 0 }, lastModifiedBy: 'Administrador' },
  ],
};
          ...
          <div key={row.id} className="bg-[#111] border border-[#333] rounded-lg p-4 space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2 text-xs">
              ...
              <div className="bg-[#1a1a1a] rounded-lg px-3 py-2">
                ...
                <span className="text-white font-bold">R$ {String(Number(row.values['col-9']) || 0)}</span>
              </div>
            </div>
          </div>
        ))}
